...
<title>오늘의 점심메뉴 :: 페이지를 찾을 수 없습니다.</title>
...
<div id="wrap">
<div id="header">
<h1><p class="menu"><a href="http://localhost:8080/index.jsp">오늘의 점심메뉴 홈</a></p></h1>
</div>
<div id="container">
...
<h2><p class="sch_desc">네이버 검색으로 원하시는 페이지를 찾으실 수 있습니다.</p></h2>
